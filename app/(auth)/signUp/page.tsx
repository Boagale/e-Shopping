  ...
  return (
    <div className="bg-[url('./../public/assets/e-comersbg-image.png')] bg-cover bg-center h-screen flex items-center justify-center">
      ...
      <main className=' bg-neutral-300 rounded-t-md'>
        <h1 className='text-xl px-4 pt-4 font-semibold text-center text-slate-500'>Register to bogi e-Shopping</h1>
        <form action="">
            ...
            <p className='text-xs text-slate-500 mt-4 text-center'>
                ...
                <Link type='submit' className='text-indigo-500 underline text-sm px-2' href={'/signIn'}>
                    Login
                </Link>
            </p>
            <div className="p-4">
